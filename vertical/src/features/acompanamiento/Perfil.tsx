...
export function PerfilScene() {
  ...
  return <DemoScene title="Mi perfil" label="Preferencias de ejemplo" navigation activeSection="profile" guide={[{ title: 'Tu espacio', text: 'Datos ficticios y preferencias locales. Reiniciar recupera el ejemplo inicial.' }]} onReset={() => { setLanguage('Español'); setAlerts(true); }}>{() => <>
