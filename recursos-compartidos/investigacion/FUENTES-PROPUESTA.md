# Fuentes y límites de la propuesta

Revisión del 17-09-2026 para planificar el librito. Las fuentes externas son
reales; los datos de la futura demo serán ficticios. No se han consultado datos
internos del despacho ni medido sus costes o conversiones.

## Informe confirmado por Pol

**Economic Scenarios for Transformative AI**, Anton Korinek, Charles I. Jones,
Szymon Sacher, Tess Cotter y Peter McCrory. The Anthropic Institute, Working
Paper 2026-02, septiembre de 2026. Pol facilitó el enlace exacto durante la sesión.

- [PDF oficial, destino previsto del QR](https://www-cdn.anthropic.com/files/4zrzovbb/website/cf58f84d46a4a76bf5a5b039ac695fba6b80041c.pdf).
- [Página y explorador de escenarios](https://www.anthropic.com/institute/econ-scenarios).
- [Copia local descargada](informes/anthropic-economic-scenarios-2026-09.pdf),
  verificada como PDF legible de 57 páginas.
- SHA-256: `9fe6667ec24b8a1dce3cde7c8ae5d5e6631bb95f68dae82dbd827cbfa2410327`.

El estudio modela escenarios de la economía estadounidense entre 2026 y 2030.
En p. 3 aclara que no son predicciones ni les asigna probabilidades. La nota 10
de p. 25 incluye «Legal (23)» entre las ocupaciones cognitivas; no presenta
un ranking que sitúe específicamente a los abogados españoles entre los más
afectados. La recomendación de dirección tecnológica será una conclusión de
Pol, separada del resultado del modelo.

Figura candidata: **figura 4, p. 34**, sobre empleo y desempleo en los tres
...
pago. Las dos llamadas anuales de 15 minutos aparecen en Plus y Pensionista;
no deben atribuirse a todos los planes. Se anuncia atención en 24 horas
laborables con matices para asuntos complejos. La videollamada es un servicio
con condiciones propias. La página también enumera oficinas en Barcelona y Madrid.
...
La [web de AS](https://segura-abogados.com/) destaca extranjería y acompañamiento.
La [consulta online](https://segura-abogados.com/consulta-online/) muestra un
formulario con nombre, correo, teléfono y asunto. No permite confirmar el
flujo posterior ni que todas las consultas se hagan exclusivamente por teléfono.
La entrega de un manual a clientes procede del relato de Pol y queda pendiente
de contrastar. La cadena de valor del plan es una interpretación para revisar.

## Ejemplos jurídicos

El [artículo 22 del Código Civil](https://www.boe.es/buscar/act.php?id=BOE-A-1889-4763#art22)
distingue el requisito general de residencia y supuestos de reducción. No son
tiempos prometidos de resolución ni planes comerciales a elegir libremente.
La regulación de pruebas se consulta separadamente en el
[RD 1004/2015](https://www.boe.es/buscar/act.php?id=BOE-A-2015-12047#a6).
...
[publicación del manual CCSE 2026](https://examenes.cervantes.es/es/noticias/publicacion-manual-ccse-2026).
La propuesta a AS debe explicar el valor añadido de integrar hábito, progreso y
acompañamiento. Para futuras preguntas, identificar la edición vigente y revisar
enunciados/respuestas; no presentar el simulador como examen oficial ni copiar
identidad visual de Duolingo.

## CV y fotografía

[LinkedIn aportado por Pol](https://www.linkedin.com/in/psurriel/). El acceso web
no devolvió el perfil y el navegador del entorno no estaba disponible. Pol aportó
después el [PDF exportado](../../tmp/linkedin.pdf) y cuatro fotos en `tmp/fotos/`.
Ambos se han leído y revisado visualmente. Las fechas y cargos se extraen de ese
documento, no de resultados de búsqueda. Se omiten las skills desactualizadas
